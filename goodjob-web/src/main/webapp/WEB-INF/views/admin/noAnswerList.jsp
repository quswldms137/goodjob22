...
.noanswer-list-title li:nth-child(1) {
	width: 15%;
}

.noanswer-list-title li:nth-child(2) {
	width: 50%;
}

.noanswer-list-title li:nth-child(3) {
	width: 15%;
	text-align: center;
}

.noanswer-list-title li:nth-child(4) {
	width: 10%;
}

.noanswer-list-title li:nth-child(5) {
	width: 10%;
}

.noanswer-list-content {
	width: 100%;
	display: flex;
	align-items:center;
	text-align: center;
...
.noanswer-list-content li:nth-child(1) {
	width: 15%;
	font-size: 14px;
	color: #aaa;
}

.noanswer-list-content li:nth-child(2) {
	width: 50%;
	text-align: left;
}

.noanswer-list-content li:nth-child(3) {
	width: 15%;
	text-align: center;
	font-size: 14px;
	color: #aaa;
...
.noanswer-list-content li:nth-child(4) {
	width: 10%;
}

.noanswer-list-content li:nth-child(5) {
	width: 10%;
}
...
.noanswer-list-content input[type="button"]{
...
<body>
	...
	<main>
		...
		<div id="container">
		<h3 class="page-title">답변 안한 문의내역</h3>
			<div id="noAnswer"></div>
		</div>
	</main>
			...
			$.ajax({
				...
				success : function(response){
					...
					response.forEach(qna => {
						...
						str += '<ul class="noanswer-list-content">';
