...
<body>
    ...
    <div id="qnaWrite" style="display: block;">
        <form name="frm-qnaForm">
            ...
            <button type="button" id="submitWrite" class="btn btn-primary btn-lg" onclick="submitQuestion(event)">문의하기</button>
            <button type="button" id="submitUpdate" class="btn btn-primary btn-lg" onclick="submitUpdate(event)">수정하기</button>
